...
fig.savefig(
    f"results/figure/Compared division density with time",
    transparent=True,
    bbox_inches="tight",
    dpi=300,
)
...
for fileType in fileTypes:
    ...
    fig.savefig(
        f"results/figure/Division Correlation figure {fileType}",
        transparent=True,
        bbox_inches="tight",
        dpi=300,
    )
    ...
    fig.savefig(
        f"results/figure/Division orientation figure {fileType}",
        transparent=True,
        bbox_inches="tight",
        dpi=300,
    )
...
for fileType in fileTypes:
    ...
    for filename in filenames:
        ...
        fig.savefig(
            f"results/figure/Change in Division density heatmap {fileType}",
            transparent=True,
            bbox_inches="tight",
            dpi=300,
        )
...
for fileType in fileTypes:
    ...
    fig.tight_layout()
    fig.savefig(
        f"results/figure/change in ori after division relative to tissue {fileType} figure",
        dpi=300,
        transparent=True,
        bbox_inches="tight",
    )
...
for fileType in fileTypes:
    ...
    fig.tight_layout()
    fig.savefig(
        f"results/figure/change in ori after division relative to wound {fileType} figure",
        dpi=300,
        transparent=True,
        bbox_inches="tight",
    )
