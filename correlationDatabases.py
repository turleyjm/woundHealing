...
# space time cell density-Q correlation
if False:
    grid = 9
    timeGrid = 18
    gridSize = 10
...
if True:
    ...
    for filename in filenames:
        ...
        dfCorMid_1 = pd.read_pickle(f"databases/correlations/dfCorMidway{filename}_1.pkl")
        dfCorMid_2 = pd.read_pickle(f"databases/correlations/dfCorMidway{filename}_2.pkl")
        dfCorMid_3 = pd.read_pickle(f"databases/correlations/dfCorMidway{filename}_3.pkl")
        dfCorMid_4 = pd.read_pickle(f"databases/correlations/dfCorMidway{filename}_4.pkl")
        dfCorMid_5 = pd.read_pickle(f"databases/correlations/dfCorMidway{filename}_5.pkl")
        dfCorMid_6 = pd.read_pickle(f"databases/correlations/dfCorMidway{filename}_6.pkl")
        dfCorMid_7 = pd.read_pickle(f"databases/correlations/dfCorMidway{filename}_7.pkl")
        dfCorMid_8 = pd.read_pickle(f"databases/correlations/dfCorMidway{filename}_8.pkl")
